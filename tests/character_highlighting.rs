...
#[test]
fn character_regions_combine_with_truncation_and_theme_backgrounds() {
    let color_pattern = regex::Regex::new(r"\x1b\[48;2;255;0;255;[0-9;]*m([^\x1b]*)").unwrap();
...
#[test]
fn character_regions_select_indicator_rows_without_highlighting_whole_lines() {
    bat()
        .args([
            "--decorations=always",
            "--color=never",
